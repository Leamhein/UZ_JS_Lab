...
### Главная страница приложения
  ...
  - главная страница приложения содержит:
    ...
    - footer со ссылками на гитхабы авторов приложения, год создания приложения. footer отображается на всех страницах приложения за исключением мини-игр.
### Электронный учебник
...
Для демоверсий, размещённых на `netlify` и `heroku`, название страницы дайте по схеме: UZrslang - название гитхаба студента
...
- Ссылку на pull request в rs app сабмитит
